...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 px-3 sm:px-6 py-6 md:py-10 relative overflow-hidden text-white">
        ...
        <div className="bg-zinc-900/30 p-5 sm:p-7 rounded-2xl border border-zinc-800/60 backdrop-blur-xl shadow-xl relative overflow-hidden space-y-5">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-3 sm:gap-4">
            ...
            <Select value={sort} onValueChange={(v) => setSort(v as SortKey)}>
              <SelectTrigger className="w-full lg:w-48 bg-zinc-950/60 border-zinc-800 text-zinc-200 h-10 text-xs sm:text-sm rounded-xl">
