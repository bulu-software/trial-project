...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-[80vh] bg-zinc-950 text-white py-6">
      <div className="max-w-6xl mx-auto space-y-8">
        
        {/* Welcome Section */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-zinc-900/40 p-6 rounded-2xl border border-zinc-800 backdrop-blur-md relative overflow-hidden">
          ...
          <div className="flex gap-3">
            <Link to="/profile">
              <Button size="sm" className="bg-zinc-800 hover:bg-zinc-700 text-zinc-100 rounded-xl flex items-center gap-1.5 border border-zinc-700">
                <Settings className="w-4 h-4" />
                Profile Settings
              </Button>
            </Link>
            <Link to="/product">
              <Button size="sm" className="bg-emerald-500 hover:bg-emerald-600 text-zinc-950 font-bold rounded-xl flex items-center gap-1.5">
                View Shop
